    ...
    public function getRules() {
        return array(
            ...
            'upd_power'=>array(
                ...
                'power_name'    =>  array('name'=>'power_name','format' => 'utf8','desc'=>'权限名','source' => 'post','default'=>''),
                'power_desc'    =>  array('name'=>'power_desc','format' => 'utf8','desc'=>'权限描述','source' => 'post','default'=>''),
                'power_pid'     =>  array('name'=>'power_pid','desc'=>'父id','source' => 'post','default'=>''),
                'controller'    =>  array('name'=>'controller','desc'=>'控制器名','source' => 'post','default'=>''),
                'action'        =>  array('name'=>'action','desc'=>'方法名','source' => 'post','default'=>''),
                'level'         =>  array('name'=>'level','desc'=>'等级','source' => 'post','default'=>''),
            ),
        );
    }
